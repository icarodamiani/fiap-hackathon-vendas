package io.fiap.hackathon.vendas.driven.repository;

import io.fiap.hackathon.vendas.driven.domain.ImmutableDocumento;
import io.fiap.hackathon.vendas.driven.domain.ImmutablePagamento;
import io.fiap.hackathon.vendas.driven.domain.ImmutablePessoa;
import io.fiap.hackathon.vendas.driven.domain.ImmutableVeiculo;
import io.fiap.hackathon.vendas.driven.domain.ImmutableVenda;
import io.fiap.hackathon.vendas.driven.domain.Pessoa;
import io.fiap.hackathon.vendas.driven.domain.Veiculo;
import io.fiap.hackathon.vendas.driven.domain.Venda;
